<template>
  <div class="max-w-[1000px] mx-auto my-16 px-4">
    ...
    <p>
      ...
      of How To Help Ukraine's Website, located at
      http://how-to-help-ukraine.com.
    </p>
    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use How To Help Ukraine if you do not agree to take all
    ...
    <p>
      We employ the use of cookies. By accessing How To Help Ukraine, you agreed
      to use cookies in agreement with the How To Help Ukraine's Privacy Policy.
    </p>
    <p>
    ...
    <p>
      Unless otherwise stated, How To Help Ukraine and/or its licensors own the
      intellectual property rights for all material on How To Help Ukraine. All
      intellectual property rights are reserved. You may access this from How To
      Help Ukraine for your own personal use subjected to restrictions set in
      these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from How To Help Ukraine</li>
      <li>Sell, rent or sub-license material from How To Help Ukraine</li>
      <li>Reproduce, duplicate or copy material from How To Help Ukraine</li>
      <li>Redistribute content from How To Help Ukraine</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. How To Help
      Ukraine does not filter, edit, publish or review Comments prior to their
      presence on the website. Comments do not reflect the views and opinions of
      How To Help Ukraine,its agents and/or affiliates. Comments reflect the
      views and opinions of the person who post their views and opinions. To the
      extent permitted by applicable laws, How To Help Ukraine shall not be
    ...
    <p>
      How To Help Ukraine reserves the right to monitor all Comments and to
    ...
    <p>
      You hereby grant How To Help Ukraine a non-exclusive license to use,
    ...
    <p>
      ...
      hyperlink compensates the absence of How To Help Ukraine; and (d) the link
    ...
    <p>
      ...
      e-mail to How To Help Ukraine. Please include your name, your organization
    ...
    <p>
      No use of How To Help Ukraine's logo or other artwork will be allowed for
